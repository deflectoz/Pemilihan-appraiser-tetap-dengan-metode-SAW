<div class="noPrint">
						<div class="col-lg-2">
							<h5> <button onClick="window.print();" class="btn btn-warning"><span
										class="oi oi-print"></span> Print Perhitungan</button></h5>
...
<div class="card">
			<div class="card-header">
				<div class="row">
					<div class="col-sm-10">
						<h5>Table Perhitungan Nama Calon</h5>
					</div>
				</div>
			</div>
			<div class="card-body">
				...
				<h2>Table 4 - Dijumlah sesuai dengan nama calon dan di dapat hasil rangking</h2>
				<div class="table-responsive">
					<table class="table table-bordered table-hover">
						<tr class="active">
							<th class="col-md-1 text-center">No</th>
				...
				<div class="alert alert-success" role="alert">
					<h4><b>Kesimpulan : </b> Dari hasil perhitungan yang dilakukan menggunakan metode SAW
						calon terbaik untuk di pilih adalah
						<?php echo $value->calon ?> dengan nilai <?php echo $value->Total ?>
					</h4>
				</div>
				<?php
                    }
